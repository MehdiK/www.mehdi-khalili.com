...
For more information on the example support refer to [this post](http://jake.ginnivan.net/blog/2014/05/06/bddfy-examples-support/). We would not have examples support in V4 without Jake's huge contribution.
